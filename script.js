...
async function processImage(file) {
    ...
    // --- PROSES PENGUMPULAN DATA DENGAN KOMPRESI ---
    try {
        const reportData = {
            ...
            // Kompres foto sebelum disimpan agar tidak memenuhi memori browser
        ...
        if (editIndex > -1) {
            ...
            // Gunakan unshift agar laporan terbaru muncul paling atas di riwayat
        ...
        console.error(error);
        alert("⚠️ GAGAL: Memori browser penuh. Silakan hapus beberapa laporan lama.");
    }
});
